...
const Chatroom = (props) => {
    ...
    async function handleSubmit(event) {
        ...
        let translatedMessageAPI = await translateTextAPI(newMessage, 'fr', destLang.lang,Settings:{Formality:'FORMAL'}); // Provide a custom terminology created outside of this deployment
